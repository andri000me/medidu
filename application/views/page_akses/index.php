...
?>
  ...
  <div class="page-title">                    
    <h2><span class="fa fa-unlock-alt"></span> <?php echo $xml->page; ?> <?php echo $xml->field->access_rule; ?></h2>
  </div>                   
          ...
          <div class="panel-heading">
            <h3 class="panel-title">Data</h3>
              ...
              <div class="btn-group pull-right">
                ...
                <button class="btn btn-success" onclick="openFormakses('create', '0');"><i class="fa fa-plus"></i> <?php echo $xml->button->add; ?> Data</button>
            ...
            <table id="example" class="display" width="100%">
              ...
              ?>
                <tr id="<?php echo $row['id']; ?>">
                  ...
                  <td>
                  <?php 
                    if (strlen($row['keterangan']) > 50) {
                      echo substr($row['keterangan'], 0, 50)." ...";
                    }else{
                      echo $row['keterangan'];                      
                    }
                  ?></td>
                  <td>                                                                                                                     
                    <div class="btn-group btn-group-sm">
                      <button class="btn btn-default" onclick="openDetailakses(<?php echo $row['id']; ?>)" data-toggle="tooltip" data-placement="bottom" title="<?php echo $xml->button->view; ?>"><i class="fa fa-eye"></i></button>
                      <button class="btn btn-default" onclick="openFormakses('update', '<?php echo $row['id']; ?>');" data-toggle="tooltip" data-placement="bottom" title="<?php echo $xml->button->update; ?>"><i class="fa fa-pencil"></i></button>                                                
                      <button class="btn btn-default" onclick="openFormakses('delete', '<?php echo $row['id']; ?>');" data-toggle="tooltip" data-placement="bottom" title="<?php echo $xml->button->delete; ?>"><i class="fa fa-trash-o"></i></button>                                        
                    </div> 
                  </td>
                </tr>
              <?php 
...
<script type='text/javascript' src='<?php echo base_url(); ?>assets/js/akses.js'></script>
