...
?>
  ...
  <ul class="breadcrumb">
    ...
    <li class="active"><?php echo $xml->page; ?> <?php echo $xml->field->genre; ?></li>
  </ul>
  <!-- END BREADCRUMB -->                
                
  <div class="page-title">                    
    <h2><span class="fa fa-tags"></span> <?php echo $xml->page; ?> <?php echo $xml->field->genre; ?></h2>
  </div>                   
          ...
          <div class="panel-heading">
            <h3 class="panel-title">Data</h3>
              ...
              <div class="btn-group pull-right">
                ...
                <button class="btn btn-success" onclick="openFormGenre('create', '0');"><i class="fa fa-plus"></i> <?php echo $xml->button->add; ?> Data</button>
                ...
                <tr id="<?php echo $row['id']; ?>">
                  ...
                  <td>                                                                                                                     
                    <div class="btn-group btn-group-sm">
                      <button class="btn btn-default" onclick="openDetailGenre(<?php echo $row['id']; ?>)" data-toggle="tooltip" data-placement="bottom" title="<?php echo $xml->button->view; ?>"><i class="fa fa-eye"></i></button>
                      <button class="btn btn-default" onclick="openFormGenre('update', '<?php echo $row['id']; ?>');" data-toggle="tooltip" data-placement="bottom" title="<?php echo $xml->button->update; ?>"><i class="fa fa-pencil"></i></button>                                                
                      <button class="btn btn-default" onclick="openFormGenre('delete', '<?php echo $row['id']; ?>');" data-toggle="tooltip" data-placement="bottom" title="<?php echo $xml->button->delete; ?>"><i class="fa fa-trash-o"></i></button>                                        
                    </div> 
                  </td>
                </tr>
              <?php 
